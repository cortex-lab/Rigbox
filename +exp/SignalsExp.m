...
>>>>>>> 1c05914056d57577d0e669365bc84b3025c0ebea
    ...
    %% properties (SetAccess && GetAccess = protected)
    ...
    %% methods (default - all public)
    
    methods
        function obj = SignalsExp(paramStruct, rig)
            % configure clock, ...?
            clock = rig.clock; %don't like shadowing the clock fn here...
            clockFun = @clock.now;
    ...
    %% methods (SetAccess && GetAccess = protected)
