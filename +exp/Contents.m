...
%   The Experiment framework provides a number of features for stimuli-
%   delivering experiments with a trial structure.  The framework also
%   provides a way to parameterize individual experiments and trials.
%   Visual and auditory stimuli can be controlled by experiment phases or
%   by a Signals reactive network.  Phases changes are managed by an
