...
elem.azimuthRange =  [-132 132];
elem.altitudeRange = [-36 36];
...
[layer.rgba, layer.rgbaSize] = vis.rgbaFromUint8_PC(uint8(127.5*(1 + pattern)), 1);
end
...
cellSize = gridDims./fliplr(nRowsByCols);
