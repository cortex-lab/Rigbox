%% Installing Rigbox
% Below are detailed, step-by-step instructions for installing Rigbox
% without any prior knowledge of Git or MATLAB.  For more succinct
% installation instructions, see the Rigbox
% <https://github.com/cortex-lab/Rigbox#installation README>.  The
...
% that step. If you are *not* installing Rigbox on a computer that will use
% a NI-DAQ for data acquistion, you can skip step 5.
%
% # Install Windows 10.  Windows must
...
% installation guide> (See note 1). During installation,
% make sure to check the box for the Data Acquisition Toolbox,
...
%% Etc.
% Authors: Jai Bhagat, Matteo Carandini, Miles Wells
%
% v0.1.0
%
