classdef wheelExpPanel < eui.ExpPanel
  ...
  methods
    function obj = wheelExpPanel(parent, ref, params, logEntry)
...
%           end
        ...
        case 'wheel'
          x = evt.Data{2};
          t = evt.Data{3};
          newTrialIdx = find(obj.InputSensorPosTime<=obj.Block.newTrialTimes(end)-obj.StartedDateTime,1,'last');
          x = iff(isempty(newTrialIdx), x, x-obj.InputSensorPos(newTrialIdx));
